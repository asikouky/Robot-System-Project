...
def generate_launch_description():
    ...
    sdf_file = os.path.join(pkg_project_description, 'models', 'limo_ackerman', 'model.sdf')
    ...
    test_script_path = os.path.join(pkg_project_bringup, 'scripts', 'test_ackerman_movement_limo1.py')
    ...
    test_script_path2 = os.path.join(pkg_project_bringup, 'scripts', 'test_ackerman_movement_limo2.py')
