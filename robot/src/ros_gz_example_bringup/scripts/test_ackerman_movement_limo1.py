...
class AckermanLimo1Test(Node):
    def __init__(self):
        super().__init__('ackerman_limo1_test')
        self.vel_publisher = self.create_publisher(Twist, 'limo1/cmd_vel', 10)
        ...
        self.get_logger().info("LIMO1 ACKERMAN TEST STARTING")
        self.get_logger().info("==================================================")
    ...
    def timer_callback(self):
        if self.test_phase == 0:
            ...
            if self.counter < 10:
                ...
                self.test_phase = 5
                self.get_logger().info("==================================================")
                self.get_logger().info("LIMO1 ACKERMAN TEST COMPLETE")
                self.get_logger().info("==================================================")
                self.destroy_node()
                rclpy.shutdown()
